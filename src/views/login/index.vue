...
<template>
  <div class="grid min-h-screen bg-slate-100 lg:grid-cols-[1fr_420px]">
    <section class="hidden bg-[linear-gradient(135deg,#e8f3ff_0%,#f7fafc_48%,#dff7ef_100%)] p-10 lg:flex lg:flex-col lg:justify-between">
      ...
      <div class="max-w-xl">
        ...
        <p class="mt-5 text-lg leading-8 text-slate-600">
          内置 Vue3、TypeScript、Pinia、Vue Router、Element Plus、Axios 和 Tailwind CSS，适合快速开展业务模块开发。
        </p>
      </div>
    ...
    <section class="flex items-center justify-center bg-white px-5">
      <div class="w-full max-w-sm">
        <div class="mb-8">
          <div class="mb-3 grid h-12 w-12 place-items-center rounded-lg bg-brand-600 text-lg font-bold text-white">
            A
          </div>
